...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['nama_kategori'])) {
        ...
        $update_query = "UPDATE kategori_barang SET nama_kategori=? WHERE id=?";
        $update = $db->prepare($update_query);
        $update->bind_param("si", $NamaKategori, $id);
...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $select_query = "SELECT * FROM kategori_barang WHERE id=?";
                        ...
                        <div class="card card-custom gutter-b">
                            <div class="card-header flex-wrap py-3">
                                <div class="card-title">
                                    <h3 class="card-label">Edit Kategori Barang </h3>
                                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                        <li class="breadcrumb-item">
                                            <a href="data-kategoribarang.php" class="text-muted">Data Kategori Barang</a>
                                        </li>
                                        <li class="breadcrumb-item">
                                            <a href="edit-kategoribarang.php" class="text-muted">Edit Data</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-6">
                                                            ...
                                                            <input type="text" class="form-control" name="nama_kategori" id="nama_kategori" value="<?php echo $data['nama_kategori']; ?>" />
