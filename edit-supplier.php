...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['nama_supplier'])) {
        ...
        $update_query = "UPDATE supplier SET nama_supplier=? WHERE id=?";
        $update = $db->prepare($update_query);
        $update->bind_param("si", $NamaSupplier, $id);
...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $select_query = "SELECT * FROM supplier WHERE id=?";
...
<body id="kt_body" class="header-fixed subheader-enabled page-loading">
                    ...
                    <div class="container">
                        ...
                        <div class="d-none d-lg-flex align-items-center mr-3">
                            ...
                            <a href="index.php" class="mr-20">
                                <img alt="Logo" src="assets/media/babycom/logo/logo-babycom.png" class="logo-default" style="max-height: 80px;" />
                            </a>
                            <!--end::Logo-->
                        </div>
                        <!--end::Left-->
                    ...
                    <div class="container">
                        ...
                        <div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default header-menu-root-arrow">
                            ...
                            <ul class="menu-nav">
                                ...
                                <!-- <li class="menu-item" data-menu-toggle="click" aria-haspopup="true">
                                    <a href="data-pakaian.php" class="menu-link">
                                ...
                                <div class="card-title">
                                    ...
                                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                        <li class="breadcrumb-item">
                                            <a href="data-supplier.php" class="text-muted">Data Supplier</a>
                                        </li>
                                        <li class="breadcrumb-item">
                                            <a href="edit-supplier.php" class="text-muted">Edit Data</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-6">
                                                            ...
                                                            <input type="text" class="form-control" name="nama_supplier" id="nama_supplier" value="<?php echo $data['nama_supplier']; ?>" />
                                                            <span class="form-text text-muted">Pastikan Nama Supplier diisi dengan huruf, bukan angka</span>
    ...
    <script>
        function validateForm() {
            ...
            var hasNumber = /\d/.test(namaSupplier); // Menguji apakah ada angka dalam input
