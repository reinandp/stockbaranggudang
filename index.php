...
// Fetch all data from 'Data Pakaian' table for the user
$query_data = "SELECT id, kode_barang, nama_barang, harga_satuan, jumlah_stock FROM stock_barang";
$result_data = $db->query($query_data);

// Include the database connection code

// Fetch data from the 'stock_barang' table
$query_data = "SELECT kode_barang, nama_barang, harga_satuan, jumlah_stock FROM stock_barang";
$result_data = $db->query($query_data);
...
if (isset($_GET['id'])) {
	...
	// Delete query
	$delete_query = "DELETE FROM stock_barang WHERE id='$id'";
...
<body id="kt_body" class="header-fixed subheader-enabled page-loading">
					...
					<div class="container">
						...
						<div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default header-menu-root-arrow">
							...
							<ul class="menu-nav">
								...
								<!-- <li class="menu-item" data-menu-toggle="click" aria-haspopup="true">
										<a href="data-packing.php" class="menu-link">
											<span class="menu-text">Data Packing</span>
										</a>
									</li>
									<li class="menu-item" data-menu-toggle="click" aria-haspopup="true">
										<a href="data-aksesoris.php" class="menu-link">
											<span class="menu-text">Data Aksesoris</span>
										</a>
									</li> -->
							</ul>
							<!--end::Header Nav-->
							...
							<div class="w-100 d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline mr-5">
										<!--begin::Page Title-->
										<!-- <h5 class="text-dark font-weight-bolder my-2 mr-5">Babycom</h5> -->
										<!--end::Page Title-->
									</div>
									<!--end::Page Heading-->
								</div>
												...
												<div class="card-body d-flex">
													<div class="d-flex py-5 flex-column align-items-start flex-grow-1">
														<div class="flex-grow-1">
															...
															<h1 class="text-white font-weight-bolder font-size-h1">Aplikasi Stock Barang</h1>
						...
						<div class="card card-custom gutter-b">
							<div class="card-header flex-wrap py-3">
								...
								<!-- <div class="card-toolbar">
									<input id="filterKodeBarang" type="text" class="form-control" placeholder="Filter Kode Barang" style="width: 200px; margin-right: 10px;" />
									<input id="filterNamaBarang" type="text" class="form-control" placeholder="Filter Nama Barang" style="width: 200px; margin-right: 10px;" />
									<button id="searchButton" class="btn btn-primary font-weight-bolder">Cari</button>
								</div> -->
								<div class="card-toolbar">
									<!--begin::Dropdown-->
									<div class="dropdown dropdown-inline mr-2">
										...
										<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
											...
											<ul class="navi flex-column navi-hover py-2">
												...
												<li class="navi-item">
													<a href="generate_csv.php?table=stock_barang" class="navi-link">
												...
												<!-- <li class="navi-item">
													<a href="javascript:void(0);" onclick="generatePDF('stock_barang')" class="navi-link">
														<span class="navi-icon">
															<i class="la la-file-pdf-o"></i>
														</span>
									...
									<!--end::Dropdown-->
									<!--begin::Button-->
									<a href="add-stockmasuk.php" class="btn btn-primary font-weight-bolder" style="margin-right: 10px;">
										<span class="svg-icon svg-icon-md">
											...
											<!--end::Svg Icon-->
										</span>Tambah Stock Masuk</a>
									<!--end::Button-->
									<a href="add-stockkeluar.php" class="btn btn-secondary font-weight-bolder">
										<span class="svg-icon svg-icon-md">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Flatten.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							...
							<div class="card-body">
								<!--begin: Datatable-->
								<table class="table table-bordered table-checkable table-responsive-sm" id="kt_datatable">
									<thead>
										<tr>
											<th>KODE BARANG</th>
											<th>NAMA BARANG</th>
									...
									<tbody>
										...
										while ($data = $result_data->fetch_assoc()) {
											...
											echo "<td>" . $data['jumlah_stock'] . " kg</td>";
											echo "</tr>";
										}
										?>
									</tbody>
	...
	<!-- <script>
		$(document).ready(function() {
			var table = new DataTable('#kt_datatable');
		});
	</script> -->
	<!-- <script>
		$(document).ready(function() {
			...
			$('#filterKodeBarang').on('keyup', function() {
				table.column(0).search(this.value).draw();
			});

			// Filter berdasarkan nama_barang
			$('#filterNamaBarang').on('keyup', function() {
			...
			$('#searchButton').on('click', function() {
				// console.log('test');
				var kodeBarangValue = $('#filterKodeBarang').val();
				var namaBarangValue = $('#filterNamaBarang').val();

				console.log('Kode Barang: ' + kodeBarangValue);
				console.log('Nama Barang: ' + namaBarangValue);

				table.column(0).search(kodeBarangValue).draw();
				table.column(1).search(namaBarangValue).draw();
			});
		});
	</script> -->
	<!--end::Global Config-->
