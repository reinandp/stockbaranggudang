...
$query_data = "SELECT id, id_kategori, kode_barang, nama_barang, harga_satuan FROM nama_barang";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $IdKategori = $_POST['id_kategori']; // Ambil id_kategori yang dikirimkan melalui formulir
    $KodeBarang = $_POST['kode_barang'];
    $NamaBarang = $_POST['nama_barang'];
    $HargaSatuan = $_POST['harga_satuan'];

    // Periksa apakah kode barang sudah ada
    if (checkKodeBarangExist($db, $KodeBarang)) {
        echo "Kode Barang sudah terdata";
    } else {
        // Lanjutkan dengan proses penambahan data ke database
        $insert_query = "INSERT INTO nama_barang (id_kategori, kode_barang, nama_barang, harga_satuan) VALUES ('$IdKategori', '$KodeBarang', '$NamaBarang', ' $HargaSatuan')";
...
<head>
    <base href="">
    <meta charset="utf-8" />
    <title>Babycom | Add Pakaian</title>
...
<body id="kt_body" class="header-fixed subheader-enabled page-loading">
                        ...
                        <div class="card card-custom gutter-b">
                            <div class="card-header flex-wrap py-3">
                                <div class="card-title">
                                    <h3 class="card-label">Add Data Nama Barang </h3>
                                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                        <li class="breadcrumb-item">
                                            <a href="data-namabarang.php" class="text-muted">Data Nama Barang</a>
                                        </li>
                                        <li class="breadcrumb-item">
                                            <a href="add-namabarang.php" class="text-muted">Add Data</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-6">
                                                            ...
                                                            <select class="form-control" name="id_kategori" id="exampleSelect1">
                                                                <?php
                                                                // Loop through the result set and create options
                                                        ...
                                                        <div class="form-group col-6">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Masukkan Harga Satuan" name="harga_satuan" id="harga_satuan" />
    ...
    <script>
        function validateForm() {
            ...
            // Validasi jika Harga Satuan bukan angka
            ...
            if (namaBarang.trim() === '' || kodeBarang.trim() === '') {
                ...
                document.getElementById('error_message').style.display = 'none';
                document.getElementById('duplicate_message').style.display = 'none';
                document.getElementById('harga_error_message').style.display = 'none';
                return false;
            } else if (hasNumber) {
                document.getElementById('empty_data_message').style.display = 'none';
