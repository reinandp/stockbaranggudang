...
// Periksa apakah pengguna telah masuk. Jika tidak, alihkan ke halaman login
...
if (isset($_SESSION['error_message'])) {
    ...
    // Hapus pesan kesalahan dari session setelah menampilkannya
...
$query_kategori = "SELECT DISTINCT id FROM kategori_barang";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Tambahkan periksa jumlah_kg dalam $_POST
    if (isset($_POST['jumlah_kg'])) {
        ...
        // Pernyataan SQL untuk mengambil jumlah_stock
        $stock_query = "SELECT jumlah_stock FROM stock_barang WHERE kode_barang = '$kode_barang'";
        ...
        if ($stock_result && $stock_result->num_rows > 0) {
            ...
            if ($jumlah_kg <= $jumlah_stock) {
                // Mulai transaksi
                $db->begin_transaction();

                // Pernyataan SQL untuk tabel stock_keluar
                $insert_querykeluar = "INSERT INTO stock_keluar (kode_nota, nama_pembeli, id_kategori, kode_barang, nama_barang, harga_satuan, jumlah_kg, total_harga, tanggal_keluar, status_bayar) VALUES 
                ('$kode_nota','$nama_pembeli','$id_kategori','$kode_barang','$nama_barang','$harga_satuan', '$jumlah_kg', '$total_harga','$tanggal_keluar', '$status_bayar')";

                if ($db->query($insert_querykeluar) === TRUE) {
                    // Commit transaksi jika pernyataan berhasil
                    $db->commit();

                    // Tambahkan kode untuk mengurangkan jumlah_stock
                    $update_querybarang = "UPDATE stock_barang SET jumlah_stock = jumlah_stock - $jumlah_kg WHERE kode_barang = '$kode_barang'";
                    if ($db->query($update_querybarang) === TRUE) {
                        header("Location: data-stockkeluar.php");
                ...
                $_SESSION['error_message'] = 'Jumlah kg melebihi jumlah stock';
           ...
           // Simpan pesan kesalahan dalam session
           $_SESSION['error_message'] = 'Kode barang tidak ditemukan';
           // Redirect kembali ke halaman add-stockkeluar
           header("Location: add-stockkeluar.php");
           exit();
        }
...
<body id="kt_body" class="header-fixed subheader-enabled page-loading">
                            ...
                            <ul class="menu-nav">
                                ...
                                <li class="menu-item menu-item-open menu-item-here menu-item-open menu-item-here" data-menu-toggle="click" aria-haspopup="true">
                                    <a href="#" class="menu-link">
                                        <span class="menu-text">Tambah Stock Keluar</span>
                                    </a>
                                </li>
                                <!-- <li class="menu-item" data-menu-toggle="click" aria-haspopup="true">
                        ...
                        <div class="card card-custom gutter-b">
                            <div class="card-header flex-wrap py-3">
                                <div class="card-title">
                                    <h3 class="card-label">Tambah Stock Keluar </h3>
                                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                        <li class="breadcrumb-item">
                                            <a href="add-stockkeluar.php" class="text-muted">Stock Keluar</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-custom gutter-b example example-compact">
                                            <!--begin::Form-->
                                            <form method="POST" id="stockForm" onsubmit="return validateForm()">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="form-group col-6">
                                                            <label for="kode_nota">Kode Nota</label>
                                                            <input type="text" class="form-control" name="kode_nota" id="kode_nota" onblur="checkKodeNotaAvailability()" required>
                                                            <!-- <span id="kode_nota_message" style="color: red; display: none;">Kode Nota sudah tersedia</span> -->
                                                        </div>
                                                        <div class="form-group col-6">
                                                        ...
                                                        <div class="form-group col-6">
                                                            ...
                                                            <select class="form-control" name="id_kategori" id="exampleSelect1" required>
                                                                <option>Pilih Kategori</option>
                                                                <?php
                                                                // Query untuk mengambil id_kategori yang unik dan nama_kategori yang sesuai
                                                                $query_kategori = "SELECT DISTINCT sm.id_kategori, kb.nama_kategori FROM stock_masuk AS sm
                      LEFT JOIN kategori_barang AS kb ON sm.id_kategori = kb.id";
                                                                $result_kategori = $db->query($query_kategori);
                                                                if ($result_kategori && $result_kategori->num_rows > 0) {
                                                                    while ($row_kategori = $result_kategori->fetch_assoc()) {
                                                                        ...
                                                                        // Tambahkan setiap id_kategori sebagai nilai dan nama_kategori sebagai teks dalam dropdown
                                                        ...
                                                        <div class="form-group col-6">
                                                            ...
                                                            <select class="form-control" name="nama_barang" id="exampleSelect3" required>
                                                                <option value="">Pilih Kategori Barang Terlebih Dahulu</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group col-6">
                                                        ...
                                                        <div class="form-group col-6">
                                                            ...
                                                            <input type="text" class="form-control" name="jumlah_kg" id="jumlah_kg" required>
                                                            ...
                                                            <span style="color: red; display: none;" id="stock_message">Stock tidak tersedia</span>
                                                        </div>
                                                        <div class="form-group col-6">
                                                        ...
                                                        <div class="form-group col-6">
                                                            <label class="col-form-label" for="kt_datepicker_3">Tanggal Keluar Barang</label>
                                                            <div class="input-group date">
                                                                <input type="text" class="form-control" readonly value="05/20/2017" id="kt_datepicker_3" required/>
                                                        ...
                                                        <div class="form-group col-6">
                                                            ...
                                                            <div class="radio-inline">
                                                                <label class="radio">
                                                                    <input type="radio" name="status_bayar" value="Lunas" checked="checked" /> Lunas
                                                                    <span></span>
                                                                </label>
                                                                <label class="radio">
                                                                    <input type="radio" name="status_bayar" value="Belum Lunas" /> Belum Lunas
                                                                    <span></span>
                                                                </label>
                                                            </div>
                                                        </div>
    ...
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script>
        // Ambil elemen input menggunakan id
        ...
        // Fungsi untuk memeriksa ketersediaan stock saat mengubah kode barang
        kodeBarangInput.addEventListener('change', function() {
            checkStockAvailability();
        });

        // Fungsi untuk memeriksa ketersediaan stock saat mengubah jumlah kg
        jumlahKgInput.addEventListener('input', function() {
            updateTotalHarga();
            checkStockAvailability();
        });
        ...
        function checkStockAvailability() {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    jumlah_kg: jumlahKgInput.value
                },


                success: function(response) {
                    if (response === 'Stok tersedia') {
                        stockMessage.textContent = ''; // Hapus pesan
                        stockMessage.style.display = 'none'; // Sembunyikan pesan
                        submitButton.removeAttribute('disabled');
                    } else if (response === 'Stok tidak tersedia') {
                        stockMessage.textContent = 'Stock tidak tersedia';
                        stockMessage.style.display = 'block'; // Tampilkan pesan
                        submitButton.setAttribute('disabled', 'disabled');

                    } else {
                        stockMessage.textContent = '';
                        stockMessage.style.display = 'none';
                        // Mungkin tambahkan logika lain jika diperlukan
                    }
        ...
        function updateTotalHarga() {
            // Ambil nilai dari harga_satuan dan jumlah_kg
            const hargaSatuan = parseFloat(hargaSatuanInput.value);
            const jumlahKg = parseFloat(jumlahKgInput.value);

            // Hitung total harga
            const totalHarga = hargaSatuan * jumlahKg;

            // Periksa apakah hasilnya adalah angka atau bukan
            if (!isNaN(totalHarga)) {
                ...
                totalHargaInput.placeholder = 'Input tidak valid';
            }
        }

        function checkKodeNotaAvailability() {
            const kodeNotaInput = document.getElementById("kode_nota");
            const kodeNotaMessage = document.getElementById("kode_nota_message");

            const kodeNota = kodeNotaInput.value;

            // Buat permintaan AJAX untuk memeriksa ketersediaan kode nota
            const ajaxRequest = new XMLHttpRequest();
            ajaxRequest.open("GET", "check-kode-nota.php?kode_nota=" + kodeNota, true);

            ajaxRequest.onreadystatechange = function() {
                if (ajaxRequest.readyState === 4 && ajaxRequest.status === 200) {
                    const response = ajaxRequest.responseText;
                    if (response === "available") {
                        // Kode nota tersedia, tampilkan pesan merah
                        kodeNotaMessage.style.display = "block";
                    } else {
                        // Kode nota tidak tersedia, sembunyikan pesan merah
                        kodeNotaMessage.style.display = "none";
                    }
                }
            };
                ...
                ajaxRequest.onreadystatechange = function() {
                    if (ajaxRequest.readyState === 4 && ajaxRequest.status === 200) {
                        ...
                        if (data.length > 0) {
                            ...
                            // Jika tidak ada data, tambahkan pilihan default untuk "Nama Barang"
                            const defaultOption = document.createElement("option");
                            defaultOption.value = "";
                            defaultOption.text = "Pilih Nama Barang";
                            namaDropdown.appendChild(defaultOption);
                ...
                ajaxRequest.onreadystatechange = function() {
                    if (ajaxRequest.readyState === 4 && ajaxRequest.status === 200) {
                        ...
                        if (data.kode_barang) {
                            ...
                            // Buat permintaan AJAX lagi untuk mengambil harga satuan berdasarkan kode_barang
                            const ajaxRequestHarga = new XMLHttpRequest();
                            ajaxRequestHarga.open("GET", "fetch-kode-harga-barang.php?kode_barang=" + data.kode_barang, true);

                            ajaxRequestHarga.onreadystatechange = function() {
                                if (ajaxRequestHarga.readyState === 4 && ajaxRequestHarga.status === 200) {
                                    const dataHarga = JSON.parse(ajaxRequestHarga.responseText);
                                    if (dataHarga.harga_satuan) {
                                        hargaSatuanInput.value = dataHarga.harga_satuan;
                                    } else {
                                        hargaSatuanInput.value = "Harga Satuan Tidak Ditemukan";
                                    }
                                }
                            };
                            ajaxRequestHarga.send();
                        } else {
                            kodeInput.value = "Kode Barang Tidak Ditemukan";
                            hargaSatuanInput.value = "Harga Satuan Tidak Ditemukan";
                        }
                    }
                };
