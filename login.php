            ...
            <div class="login-aside d-flex flex-row-auto bgi-size-cover bgi-no-repeat p-10 p-lg-10" style="background-image: url(assets/media/bg/bg-4.jpg);">
                ...
                <div class="d-flex flex-row-fluid flex-column justify-content-between">
                    ...
                    <a href="#" class="flex-column-auto mt-5">
                        <img src="assets/media/babycom/logo/logo-babycom.png" class="max-h-100px" alt="" />
                    </a>
                    <!--end: Aside header-->
                    <!--begin: Aside content-->
                    <div class="flex-column-fluid d-flex flex-column justify-content-center">
                        <p class="font-weight-lighter text-white opacity-80">Welcome to</p>
                        <h3 class="font-size-h1 mb-5 text-white">Aplikasi Stock Barang</h3>

                    </div>
                    <!--end: Aside content-->
                    <!--begin: Aside footer for desktop-->
                    <div class="d-none flex-column-auto d-lg-flex justify-content-between mt-10">
                        <div class="opacity-70 font-weight-bold text-white">© 2023 Vultra</div>
                        <!-- <div class="d-flex">
                        ...
                        <div class="text-center mb-10 mb-lg-20">
                            ...
                            <form method="POST" class="form">
                                <div class="form-group">
                                    <input class="form-control form-control-solid h-auto py-5 px-6" type="text" placeholder="Username" name="username" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group d-flex flex-wrap justify-content-between align-items-center">
                                    ...
                                    <button type="submit" name="submit" class="btn btn-primary font-weight-bold px-9 py-4 my-3">Sign In</button>
                                </div>
                                <!--end::Action-->
                            </form>
