...
$query_data = "SELECT nb.id, kb.nama_kategori AS id_kategori, nb.kode_barang, nb.nama_barang, nb.harga_satuan 
              FROM nama_barang nb
              JOIN kategori_barang kb ON nb.id_kategori = kb.id";
...
//     $insert_query = "INSERT INTO nama_barang (nama_kategori, nama_barang) VALUES ('$NamaKategori', '$NamaBarang')";
...
if (isset($_GET['id'])) {
	...
	// Delete query
	$delete_query = "DELETE FROM nama_barang WHERE id='$id'";
						...
						<div class="card card-custom gutter-b">
							<div class="card-header flex-wrap py-3">
								<div class="card-title">
									<h3 class="card-label">Data Nama Barang
								</div>
								<div class="card-toolbar">
									...
									<!--end::Dropdown-->
									<!--begin::Button-->
									<a href="add-namabarang.php" class="btn btn-primary font-weight-bolder">
										<span class="svg-icon svg-icon-md">
								...
								<table class="table table-bordered table-checkable table-responsive-sm" id="kt_datatable">
									...
									<tbody>
										...
										while ($data = $result_data->fetch_assoc()) {
											...
											echo "<td>";
											echo '<a href="edit-namabarang.php?id=' . $data['id'] . '" class="btn btn-sm btn-clean btn-icon" title="Edit details">';
											echo '<i class="la la-edit"></i>';
											echo '</a>';
											echo '<a href="data-namabarang.php?id=' . $data['id'] . '" class="btn btn-sm btn-clean btn-icon" title="Delete">';
