                        ...
                        <div class="card card-custom gutter-b">
                            <div class="card-header flex-wrap py-3">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <!--end::Dropdown-->
                                    <!--begin::Button-->
                                    <a href="add-supplier.php" class="btn btn-primary font-weight-bolder">
                                        <span class="svg-icon svg-icon-md">
                                ...
                                <table class="table table-bordered table-checkable table-responsive-md" id="kt_datatable">
                                    ...
                                    <tbody>
                                        ...
                                        while ($data = $result_data->fetch_assoc()) {
                                            ...
                                            echo "<td>";
                                            echo '<a href="edit-supplier.php?id=' . $data['id'] . '" class="btn btn-sm btn-clean btn-icon" title="Edit details">';
                                            echo '<i class="la la-edit"></i>';
                                            echo '</a>';
                                            echo '<a href="data-supplier.php?id=' . $data['id'] . '" class="btn btn-sm btn-clean btn-icon" title="Delete">';
