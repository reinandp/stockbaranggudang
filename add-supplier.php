...
$query_data = "SELECT id, nama_supplier FROM supplier";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insert_query = "INSERT INTO supplier (nama_supplier) VALUES ('$NamaSupplier')";
                        ...
                        <div class="card card-custom gutter-b">
                            <div class="card-header flex-wrap py-3">
                                <div class="card-title">
                                    <h3 class="card-label">Add Data Supplier </h3>
                                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                        <li class="breadcrumb-item">
                                            <a href="data-supplier.php" class="text-muted">Data Supplier</a>
                                        </li>
                                        <li class="breadcrumb-item">
                                            <a href="add-supplier.php" class="text-muted">Add Data</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-6">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Masukkan Nama Supplier" name="nama_supplier" id="nama_supplier" />
